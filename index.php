...
<body class="bg-black text-white">
    ...
    <div id="main-content-wrapper" class="flex-grow">
        <div id="view-dashboard" class="view active dashboard-background">
            ...
            <div class="dashboard-content">
                <div id="dashboard-ui-elements">
                    <header id="dashboard-header" class="mb-4" style="background-size: cover; background-position: center;">
                     ...
                     <div id="operation-mode-container" class="bg-gray-800 bg-opacity-70 p-3 rounded-lg border border-gray-600 flex justify-center items-center gap-6 mb-4">
        ...
        <div id="view-graph" class="view container mx-auto p-4 sm:p-6 lg:p-8">
        ...
        <div id="view-status" class="view container mx-auto p-4 sm:p-6 lg:p-8">
            <header class="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-8">
        ...
        <div id="view-settings" class="view container mx-auto p-4 sm:p-6 lg:p-8">
