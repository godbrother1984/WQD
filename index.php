                         ...
                         <div class="pt-6 border-t">
                            ...
                            <div class="space-y-6">
                                ...
                                <div class="pt-4 border-t">
                                    <label class="block text-sm font-medium mb-2">Dashboard Padding (px)</label>
                                    <div class="grid grid-cols-4 gap-4">
                                        <div>
                                            <label for="settings-margin-top" class="block text-xs font-medium text-gray-500">Top</label>
                                            <input type="number" id="settings-margin-top" class="settings-input">
                                        </div>
                                        <div>
                                            <label for="settings-margin-right" class="block text-xs font-medium text-gray-500">Right</label>
                                            <input type="number" id="settings-margin-right" class="settings-input">
                                        </div>
                                        <div>
                                            <label for="settings-margin-bottom" class="block text-xs font-medium text-gray-500">Bottom</label>
                                            <input type="number" id="settings-margin-bottom" class="settings-input">
                                        </div>
                                        <div>
                                            <label for="settings-margin-left" class="block text-xs font-medium text-gray-500">Left</label>
                                            <input type="number" id="settings-margin-left" class="settings-input">
                                        </div>
                                    </div>
                                </div>
